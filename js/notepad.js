...
var notepad={
	padHTML:'<div class="notepad"><span class="close" title="Close Notepad" style="font-family:OCR-A;">X</span>'
				
				+'<form></form>'   //noteHTML goes here//
				+'</div>',
	...
	loadpad:function(id, position){
		...
		if (largestorage["notepad_"+id]) //if note contains persisted data
			setInterval(function(){savenote()},1000)
			else setInterval(function(){savenote()},1000)
